...
const LorebooksPage = () => {
    ...
    return (
    <div className="w-full p-4 h-[calc(100vh-3rem)] flex flex-col gap-2 grow-0 overflow-y-auto overflow-x-hidden lg:p-8">
        <div className="grid grid-cols-3 w-full h-full gap-2">
            ...
            <div className="col-span-2 themed-root gap-2 h-full overflow-y-auto flex flex-col slide-in-right">
